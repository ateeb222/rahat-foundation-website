...
export default function CancellationAndRefundPage() {
  return (
    <PolicyPage
      ...
      summary="This policy explains how to stop future recurring debits and how Rahat reviews duplicate, mistaken, unauthorised, or technically incorrect donation payments."
    >
      <h2>1. One-time donations</h2>
      <p>
        A successfully processed voluntary donation is generally final because Rahat may begin allocating or committing funds to the stated charitable purpose after reconciliation. A change of mind alone does not automatically create a right to a refund.
      </p>

      <h2>2. Circumstances in which a refund may be reviewed</h2>
      <p>Rahat may consider a refund request where there is credible evidence of:</p>
      <ul>
        ...
        <li>A successful debit where Rahat cannot accept the contribution under applicable law or its domestic-donation restrictions.</li>
      ...
      <p>
        Contact Rahat as soon as possible, preferably within seven calendar days of the transaction, at{' '}
      ...
      <p>
        Rahat will verify the request against payment-provider records, bank settlement information, internal accounts, campaign commitments, and applicable legal obligations. Additional identity or account-holder verification may be required. Submission of a request does not guarantee approval.
      </p>
      <p>
        Where approved, the refund will ordinarily be sent back through the original payment channel or to a verified source account. Processing time depends on Razorpay, the bank, UPI participant, card network, and settlement status. Rahat will communicate the available reference or status after initiating an approved refund.
      </p>

      <h2>5. Recurring mandate cancellation</h2>
      <p>
        A donor may cancel future recurring debits at any time through the relevant UPI application, bank, Razorpay mandate-management facility where available, or by contacting Rahat. Please act sufficiently before the next scheduled debit because a cancellation request that has not yet been processed may not stop an already initiated debit.
      </p>
      <p>
      ...
      <p>
        Do not make repeated payments merely because the first transaction appears pending. Check the bank or UPI account and payment status first. Failed or automatically reversed transactions are normally handled by the payment provider or bank and are not treated as received donations unless Rahat&apos;s settlement records show successful receipt.
      </p>

      <h2>7. Chargebacks and disputes</h2>
      <p>
        Before initiating a bank dispute or chargeback, contact Rahat so the transaction can be identified and reviewed. Fraudulent, misleading, or duplicate chargeback claims may be contested using payment, consent, mandate, and communication records.
      </p>

      <h2>8. Contact</h2>
      <p>
        Refund and cancellation requests must be made through official Rahat channels. Rahat will never ask for your UPI PIN, OTP, CVV, or banking password to process a cancellation or refund.
      </p>
    </PolicyPage>
  );
}
