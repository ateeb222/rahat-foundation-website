...
export const metadata: Metadata = {
  title: 'Provisional Approval under Section 354(4)',
  description: 'Verified details of Rahat Social Impact Foundation provisional Income Tax approval.',
};

export default function ApprovalOrderPage() {
  return (
    <main className="min-h-screen bg-[#F8F5EF] px-4 py-10 text-[#1F2937] sm:px-6 sm:py-14">
      <article className="mx-auto max-w-4xl rounded-3xl border border-[#D9A441]/40 bg-white p-5 shadow-sm sm:p-8">
        ...
        <h1 className="mt-3 text-3xl font-bold leading-tight text-[#07361F] sm:text-4xl">Provisional Donor-Deduction Approval</h1>
        <p className="mt-4 text-base leading-7 text-slate-700">Form No. 106 order granting provisional approval to Rahat Social Impact Foundation for charitable activities.</p>
        <dl className="mt-6 grid gap-4 rounded-2xl bg-[#F8F5EF] p-5 sm:grid-cols-2">
          <div><dt className="text-sm font-bold text-slate-500">Section</dt><dd className="mt-1 font-bold">354(4)</dd></div>
